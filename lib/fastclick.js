...
FastClick.prototype.onMouse = function(event) {
	...
	// If mouse event are permitted, return true for the action to go through.
	return true;
};


/**
 * Set element active without scrolling to it
 *
 * @param {EventTarget|Element} targetElement
 * @returns {void}
 */
FastClick.prototype.setActive = function(targetElement) {
	...
	// It's the simplest solution (flickering is possible)
	// More complicated way may be found in wysihtml5 project (focusWithoutScrolling function):
	// https://github.com/xing/wysihtml5/blob/master/src/views/composer.style.js
...
FastClick.prototype.onClick = function(event) {
	...
	if (!this.needsClick(oldTargetElement) || this.cancelNextClick) {
		...
		if (this.getTargetElementFromEventTarget(event.target) !== oldTargetElement) {
			this.setActive(oldTargetElement);
		}
